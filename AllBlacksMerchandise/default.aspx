...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<	<div class="box">
		<table>
			...
			<tr>
				<td>Show your support for New Zealand rugby in this men's jersey. A version of the one the All Blacks wear when they play on home soil...<br/><a href="jerseys.html"> Click here for more. </a> </td>
				<td>All Blacks men's polo shirt. The shirt features a ribbed rugby collar and ribbed cuffs. An All Blacks tonal print accross the upper back and a high-density team logo...<br/><a href="mens.html"> Click here for more. </a> </td>
				<td>Constructed using adidas' Climalite technology fabric, Embossed logos, New look button up performance rugby collar design...<br/><a href="womens.html"> Click here for more. </a> </td>
			</tr>
		</table>
		...
		<table>
			...
			<td>
				<table>
					...
					<tr>
						<td colspan="4"> More Images <a href="gallery.html">Here...</a> </td>
					</tr>
				</table>
			</td>
		</table>
